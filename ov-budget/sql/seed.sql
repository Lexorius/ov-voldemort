...
('notify_connector_alarm','1','Melden: Connector-Pruefung schlaegt an','An die Leitung, wenn die taegliche Pruefung fremde oder veraenderte Dateien findet','bool','Home Assistant',138),
...
('ha_mqtt_fahrzeuge','0','Je Fahrzeug eigene Entitäten','Status, Funkstatus, HU, SP, UVV, Kilometerstand und offene Aufträge je Fahrzeug – ohne Funkkennungen','bool','Home Assistant',30),
('ha_mqtt_position','0','Fahrzeugstandort als Karte-Eintrag','Position aus Divera oder aus den QR-Standortmeldungen; erzeugt je Fahrzeug einen device_tracker. Verrät, wo ein Fahrzeug steht – nur einschalten, wenn der Broker vertrauenswürdig ist','bool','Home Assistant',40),
